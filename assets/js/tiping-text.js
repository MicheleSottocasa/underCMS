...
! function(window, document, $) {
	...
	var defaults = {
		strings: ["Hi I'm <strong>Michele <br class='mobile'>Sottocasa</strong>", "18 years old <br class='mobile'>teenager", "Junior Web <br class='mobile'>Developer"],
		stringsElement: null,
		// typing speed
		typeSpeed: 0,
